...
uses
  CodeReader, TokenType, WordMap, SourceToken, JCFLog;
...
type
  ...
  private
    ...
    procedure LogToken(const pc: TSourceToken);
...
function TTokeniser.GetNextToken: TSourceToken;
var
...
function TTokeniser.TryEOF(const pcToken: TSourceToken): boolean;
begin
  Result := False;
...
function TTokeniser.TryBracketStarComment(const pcToken: TSourceToken): boolean;
begin
  Result := False;
...
function TTokeniser.TryCurlyComment(const pcToken: TSourceToken): boolean;
begin
  Result := False;
...
function TTokeniser.TrySlashComment(const pcToken: TSourceToken): boolean;
var
  liLen: integer;
begin
  Result := False;
...
function TTokeniser.TryReturn(const pcToken: TSourceToken): boolean;
var
  chNext: char;
begin
  Result := False;
...
function TTokeniser.TryLiteralString(const pcToken: TSourceToken): boolean;
...
function TTokeniser.TryWord(const pcToken: TSourceToken): boolean;
...
function TTokeniser.TryWhiteSpace(const pcToken: TSourceToken): boolean;
begin
  Result := False;
...
function TTokeniser.TryAssign(const pcToken: TSourceToken): boolean;
begin
  Result := False;
...
function TTokeniser.TryNumber(const pcToken: TSourceToken): boolean;
begin
  Result := False;
...
function TTokeniser.TryHexNumber(const pcToken: TSourceToken): boolean;
begin
  Result := False;
...
function TTokeniser.TryDots(const pcToken: TSourceToken): Boolean;
begin
  Result := False;
...
function TTokeniser.TryOperator(const pcToken: TSourceToken; const ch: char; const pw: TWord): boolean;
begin
  Result := False;
...
function TTokeniser.TryPunctuation(const pcToken: TSourceToken): boolean;
...
function TTokeniser.TrySingleCharToken(const pcToken: TSourceToken; const ch: char;
...
procedure TTokeniser.LogToken(const pc: TSourceToken);
var
  //lsType: string;
...
procedure TTokeniser.FileEnd;
begin
  inherited;

  Log.Write(IntToStr(fiCount) + ' tokens found');
  fiCount := 0;
end;

procedure TTokeniser.FileStart;
begin

end;

procedure TTokeniser.RunEnd;
begin

end;

procedure TTokeniser.RunStart;
begin
