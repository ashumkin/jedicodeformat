...
Portions created by Anthony Steele are Copyright (C) 2004-2008 Anthony Steele.
All Rights Reserved. 
...
exports
  ...
  JcfProcessFile,
  JcfFormatFile,
  JcfSetOnFormatStatusMessage,
  JcfSetOnFileFormatStatusMessage,
  JcfClearFormat,
