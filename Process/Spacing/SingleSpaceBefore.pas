...
begin
  ...
  begin
    if JcfFormatSettings.Spaces.SpaceBeforeCloseBrackets then
    begin
      Result := true;
      exit;
    end;
  ...
  begin
    if JcfFormatSettings.Spaces.SpaceBeforeOpenBracketsInFunctionDeclaration then
    begin
    ...
    if JcfFormatSettings.Spaces.SpaceBeforeOpenBracketsInFunctionCall then
    begin
  ...
  begin
    if JcfFormatSettings.Spaces.SpaceBeforeOpenSquareBracketsInExpression then
    begin
  ...
  if JcfFormatSettings.Spaces.SpaceForOperator = eAlways then
  begin
