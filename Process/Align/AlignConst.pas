...
begin
  Result := ( not JcfFormatSettings.Obfuscate.Enabled) and JcfFormatSettings.Align.AlignConst;
end;
...
begin
  Result := (pt <> nil) and (pt.HasParentNode(nConstSection)) and
    (( not JcfFormatSettings.Align.InterfaceOnly)) or (pt.HasParentNode(nInterfaceSection));
end;
