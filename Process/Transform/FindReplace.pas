...
begin
  Result := JcfFormatSettings.Replace.Enabled;
end;
...
begin
  ...
  if not JcfFormatSettings.Replace.HasWord(lcSourceToken.SourceCode) then
    exit;

  lcSourceToken.SourceCode := JcfFormatSettings.Replace.Replace(lcSourceToken.SourceCode);
  Inc(fiCount);
end;
